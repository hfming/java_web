...
public abstract class DAO<T> {
     ...
     * @return
     */
    public T querySingle(Class<T> type, Connection connection, String sql, Object... args) {
        try {
     ...
     * @return
     */
    public List<T> queryTable(Class<T> type, Connection connection, String sql, Object... args) {
        try {
